...
/**
 * holyBasil.jsx
 * 4 Growth Stages for Holy Basil (กะเพรา):
 * 1. HolyBasilSeed
 * 2. HolyBasilSeedling
 * 3. HolyBasilMature (with serrated leaf edges and purple-reddish stems)
 * 4. HolyBasilFruiting (with delicate branching flower racemes)
 */
...
export function HolyBasilMature() {
  return (
    <svg viewBox="0 0 240 240" className="gs-plant-svg" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Characteristic Serrated/Toothed Holy Basil Leaf Clusters */}
      {/* Lower Left Cluster */}
      ...
      {/* Crown Canopy with serrated tips */}
...
export function HolyBasilFruiting() {
  return (
    <svg viewBox="0 0 240 240" className="gs-plant-svg" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* CHARACTERISTIC BRANCHED HOLY BASIL FLOWER RACEMES */}
      {/* Central Raceme */}
      <g>
        <path d="M120 75 L120 10" stroke="#86198f" strokeWidth="3" strokeLinecap="round" />
        {/* Tiny Pink-Purple Flower Whorls */}
