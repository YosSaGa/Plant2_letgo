...
/**
 * chili.jsx
 * 4 Growth Stages for Chili Pepper (พริก):
 * 1. ChiliSeed
 * 2. ChiliSeedling
 * 3. ChiliMature
 * 4. ChiliFruiting
...
export function ChiliFruiting() {
  return (
    <svg viewBox="0 0 240 240" className="gs-plant-svg" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Hanging Glossy Red Chili Pepper 1 (Left Hanging) */}
      <g>
      ...
      {/* Hanging Glossy Red Chili Pepper 2 (Center Right) */}
      <g>
      ...
      {/* Young Green Chili Pepper (Right Hanging) */}
      <g>
