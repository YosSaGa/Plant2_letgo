import { BarChart3, Leaf, LogOut, Users } from 'lucide-react';
...
export default function AdminLayout({ children, fullBleed = false }) {
  ...
  return <main className={`admin-root${fullBleed ? ' admin-map-shell' : ''}`}>
    <aside className="admin-sidebar">
      ...
      >
        <motion.span animate={reduceMotion ? undefined : { rotate: [0, 8, -8, 0] }} transition={{ duration: 2.5, repeat: Infinity, repeatDelay: 3 }}>🌱</motion.span>
        <div>PlookPloen<small>CONTROL ROOM</small></div>
      </button>
